const ProjectStatCard = ({ icon: Icon, label, value, tone }) => (
  <div className="rounded-[18px] border border-border/45 bg-white/90 p-4 shadow-[0_2px_12px_rgba(15,23,42,0.04)]">
    ...
    <p className="text-[20px] sm:text-[22px] font-semibold text-heading tracking-tight tabular-nums leading-none truncate">
      {value}
    </p>
